...
const Home = () => {
  ...
  const redLineRef = React.useRef(null);
  const logoRef = React.useRef(null);
  const accentLineRef = React.useRef(null);
  const eventTagsRef = React.useRef(null);
    ...
    >
      ...
      <div className="relative z-10 flex flex-col max-w-5xl md:mx-18">
        ...
        <div ref={eventTagsRef} className="flex flex-col gap-3">
          ...
          <p ref={footerTextRef} className="text-sm md:text-xl font-medium text-white/70 italic tracking-[0.1em] mt-2">
