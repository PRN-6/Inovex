export const culturalEventsData = {
  9: {
    ...
    rules: [
      "The team size consists of min 4 and max 12 members",
      "The time limit is 5 minutes, with an additional 2 minutes allotted for stage setup",
      "Participants are required to wear strict corporate or formal attire",
      "Participants must submit their music in advance, preferably in MP3 format",
      "Only minimal and safe props allowed (no smoke, fireworks etc)",
      "Report 30–45 minutes before the event",
    ...
    coordinators: [
      {
        name: "Divyalaxmi Poojary",
        contact: "9945013602",
        photo: "/images/event-heads/mba/Divyalaxmi.webp"
      },
      {
        name: "Thrisha",
        contact: "9019373499",
        photo: "/images/event-heads/mba/Thrisha.webp"
      }
    ],
    facultyCoordinators: [
      {
  ...
  10: {
    id: 10,
    title: "Jurassic Jams: Group Song",
    type: "cultural",
    category: "Cultural",
    date: "May 16, 2026",
    time: "10:30 AM",
    location: "seminar hall 1",
    participants: "Team of 6-8",
    entryFee: "₹400",
    description: "Bring your team spirit and musical talent to the stage in the Group Song event. Participants will perform together showcasing coordination, vocals, rhythm, and overall stage performance. Judging will be based on song selection, harmony, creativity, and presentation.",
    rules: [
      "The team should consist of a minimum of 6 and a maximum of 8 participants",
      "Time limit: 4+1 minutes, including setting time",
      "Judgment will be based on quality of singing, rhythm, pitch, clarity, and overall impression",
      "Instruments are permitted",
      "Western song category: Any pure Western song forms are allowed in Kannada, Hindi, or English language",
      "Music tracks must be provided in a pen drive and submitted to the coordinator prior to the event"
    ],
    coordinators: [
      {
        name: "Liya Mohan",
        contact: "7994342845",
        photo: "/images/event-heads/mca/Liya.webp"
      },
      {
        name: "Raksha",
        contact: "7795763247",
        photo: "/images/event-heads/mca/Raksha.webp"
      }
    ],
    facultyCoordinators: [
      {
  ...
  11: {
    id: 11,
    title: "Rexora: Group Dance",
    type: "cultural",
    category: "Cultural",
    date: "May 16, 2026",
    time: "11:30 AM",
    location: "seminar hall 3",
    participants: "Team of 10-12",
    entryFee: "₹400",
    ...
    coordinators: [
      ...
      },
      {
        name: "Priya",
        contact: "6361658052",
        photo: "/images/event-heads/mca/Priya.webp"
      }
    ],
    facultyCoordinators: [
      {
  ...
  12: {
    ...
    rules: [
      "This is a solo dance competition, and all dance forms are allowed",
      "The maximum performance time is 5 minutes",
      "Participants must submit their audio track one day prior to the event",
      "Participants should report 30 minutes before the competition",
      "Judges’ decision will be final, and vulgarity is strictly prohibited"
    ],
    coordinators: [
      {
        name: "Maneesha P",
        contact: "9446697501",
        photo: "/images/event-heads/mba/Maneesha.webp"
      },
      {
        name: "Shreelaxmi",
        contact: "8951369579",
        photo: "/images/event-heads/mba/shreelaxmi.webp"
      }
    ],
    facultyCoordinators: [
      {
  ...
  18: {
    ...
    rules: [
      "Dancers will be challenged to dance to the unpredictable, varied beats of a DJ",
      "The music genre will change for each pair of dancers and can range from any genre of music such as rap, pop, breakbeats, funk, electronica, house music, hip hop etc",
      "Judges will choose 1 dancer from each battle to advance to the next round until the battle progresses to 2 final dancers",
      "Each dancer will be judged on his/her artistic creativity, his/her musicality, and his/her ability to entertain the judges"
    ],
    coordinators: [
      {
